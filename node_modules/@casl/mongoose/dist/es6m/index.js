...
function toMongoQuery(ability, ...args) {
  return rulesToQuery(ability, args[1] || 'read', args[0], convertToMongoQuery);
}
...
function accessibleBy(ability, action) {
  ...
  return this instanceof Query ? this.and([query]) : this.where({
    $and: [query]
  });
}
...
export { accessibleFieldsPlugin, accessibleRecordsPlugin, toMongoQuery };
